        ...
        <div className="fade-in-up animate">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <p className="text-lg text-muted-foreground leading-relaxed">
              Hi, I'm a Software Engineer with a strong foundation in web development and a passion for building 
              high-quality digital experiences. I specialize in the <span className="text-primary font-semibold">MERN stack</span> 
              (MongoDB, Express.js, React, Node.js) and have hands-on experience with Java and Python. 
              I take pride in writing clean, efficient, and scalable code to deliver robust, user-friendly applications.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed mt-4">
              I'm also interested in <span className="text-primary font-semibold">Artificial Intelligence and Machine Learning</span>, 
              and have started exploring and building projects in this area. Driven by curiosity and a commitment to continuous learning, 
              I stay up to date with the latest technologies to solve complex problems and create impactful solutions.
            </p>
          </div>
