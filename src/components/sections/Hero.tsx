...
export const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen w-full relative pt-28 sm:pt-36 pb-24 flex flex-col justify-between border-b border-[#D9D2C5] bg-[#F5F0E6]"
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full my-auto">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-between gap-4 mb-12 pb-4 border-b border-[#D9D2C5]"
        >
          <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 bg-[#EEE8DC] rounded-full border border-[#D9D2C5]">
          ...
          <div className="flex items-center gap-3 font-mono text-xs text-[#555048] font-semibold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            >
              <p className="text-lg sm:text-2xl text-[#3A3630] font-normal leading-relaxed">
            ...
            >
              ...
              <div className="flex items-center gap-2 sm:ml-4 border-l border-[#D9D2C5] pl-4 py-1">
                <a
                  href="https://github.com/hitesh-kumar123"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-full border border-[#D9D2C5] bg-[#EEE8DC] text-ink hover:border-cobalt hover:text-cobalt hover:bg-white transition-all shadow-xs"
          ...
          <div className="lg:col-span-4 flex justify-center lg:justify-end">
            ...
            >
              {/* Offset Accent Layer */}
              <div className="absolute inset-0 bg-cobalt rounded-3xl translate-x-3 translate-y-3 -z-10 group-hover:translate-x-4 group-hover:translate-y-4 transition-transform duration-300" />
