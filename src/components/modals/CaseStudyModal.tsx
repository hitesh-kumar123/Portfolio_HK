      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 lg:p-10 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl bg-[#F5F0E6] rounded-3xl border border-[#D9D2C5] shadow-2xl overflow-hidden my-auto max-h-[90vh] flex flex-col z-10"
          >
            {/* Header Bar */}
            <div className="flex items-center justify-between px-6 sm:px-8 py-5 border-b border-[#D9D2C5] bg-[#EEE8DC]">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#D9D2C5] font-bold">•</span>
                <span className="font-mono text-xs font-semibold uppercase tracking-wider text-[#555048]">
                  {project.category}
                </span>
              </div>
            ...
            <div className="p-6 sm:p-10 overflow-y-auto space-y-10">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xl sm:text-2xl text-[#555048] font-medium">
                  {project.tagline}
                </p>
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {project.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="px-3.5 py-1 text-xs font-semibold bg-[#EEE8DC] text-ink rounded-full border border-[#D9D2C5]"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              {/* Cover Image */}
              <div className="relative aspect-[16/9] w-full overflow-hidden rounded-2xl bg-black/5 border border-[#D9D2C5]">
                <img
                  src={project.image}
                  alt={project.title}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                ...
                {/* Overview */}
                <div className="space-y-2 p-5 bg-[#EEE8DC] rounded-xl border border-[#D9D2C5]">
              ...
              <div className="space-y-3 pt-4 border-t border-[#D9D2C5]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {project.caseStudy.features.map((feature, idx) => (
                    <div key={idx} className="flex items-start gap-2.5 p-3.5 bg-[#EEE8DC] rounded-xl border border-[#D9D2C5]">
              ...
              <div className="space-y-4 pt-4 border-t border-[#D9D2C5]">
                <span className="font-mono text-xs font-bold uppercase tracking-wider text-cobalt">
                  Technical Challenges &amp; Solutions
                </span>
                <div className="space-y-3">
                  {project.caseStudy.challenges.map((challenge, idx) => (
                    <div key={idx} className="p-4 bg-[#EEE8DC] rounded-xl border border-[#D9D2C5] space-y-2">
                      <div className="flex items-center gap-2 text-xs font-bold text-ink">
                        <AlertCircle size={14} className="text-cobalt" />
                        <span>Challenge: {challenge}</span>
                      </div>
                      <div className="text-xs text-[#3A3630] font-normal pl-5 border-l-2 border-cobalt leading-relaxed">
            ...
            {/* Bottom Actions Bar */}
            <div className="flex items-center justify-between px-6 sm:px-8 py-5 border-t border-[#D9D2C5] bg-[#EEE8DC]">
              <a
